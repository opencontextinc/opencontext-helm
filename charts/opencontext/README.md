...
| app.bitbucket.appAuth.appPassword | string | `nil` |  |
| app.bitbucket.appAuth.username | string | `nil` |  |
| app.bitbucket.authType | string | `"appPassword"` |  |
| app.bitbucket.enabled | bool | `false` |  |
| app.bitbucket.host | string | `nil` |  |
| app.bitbucket.token | string | `nil` |  |
| app.catalog.intervalSecs | int | `200` |  |
| app.catalog.locations.githubDiscovery | list | `[]` |  |
| app.catalog.locations.githubOrg | list | `[]` |  |
...
| app.github.token | string | `"MY_TOKEN"` |  |
